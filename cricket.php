...
<html lang="en">
  <head>
    ...
    <title>Cricket Jerseys - SportsHub</title>
  ...
  <body class="cricketB">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav m-auto">
            ...
            <li class="nav-item"><a class="nav-link active" href="cricket.php">Cricket Jerseys</a></li>
    ...
    <div class="container my-2">
      <h1 class="text-center text-light">Cricket Jerseys</h1>
      <p class="text-center text-light">Get your favorite cricket team's jersey and show your support.</p>
      <div class="row g-4">
        <?php
        include 'db.php';
        $query = "SELECT * FROM products WHERE catagory = 'cricket'";
