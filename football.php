...
<head>
  ...
  <title>Football Jerseys - SportsHub</title>
...
<body class="footballbg">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav m-auto">
          ...
          <li class="nav-item"><a class="nav-link active" href="football.php">Football Jerseys</a></li>
  ...
  <div class="container my-2">
    <h1 class="text-center text-light">Football Jerseys</h1>
    <p class="text-center text-light">Explore our collection of football jerseys from top clubs and national teams.</p>
    <div class="row g-4">
      <?php
      include 'db.php';
      $query = "SELECT * FROM products WHERE catagory = 'football'";
